...
function Root({setData}) {
  ...
  return (
    <section className='w-screen h-screen flex justify-center items-center'>
        <div className='w-[60%] h-[80%] block bg-black rounded-3xl'>
            ...
            <div className='h-1/4 w-full flex justify-center items-center'>
                <Link onClick={() => setData("istvan")} to={"/school_portfolio_web/istvan"} className='hover:text-4xl duration-150 text-sky-700 text-2xl'>István</Link>
            </div>
        </div>
    </section>
  )
